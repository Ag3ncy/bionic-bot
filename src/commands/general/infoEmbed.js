...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .setAuthor({ name: 'Some name', iconURL: 'https://pbs.twimg.com/profile_images/1735589406910656512/VDXbIvLI_400x400.jpg', url: 'https://bionicdao.com' })
